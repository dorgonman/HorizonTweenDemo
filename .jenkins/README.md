# Jenkins Automation for HorizonTweenDemo

This directory contains the Jenkins Pipeline configuration for the HorizonTweenDemo project. It uses a shared pipeline library to provide standardized Unreal Engine build and test workflows.
...
- `HorizonPlugin/HorizonTweenDemo/Build/Development` — `*StandaloneTestReport.tar` and `Intermediate/BuildArchive/doc/` public docs.
- `HorizonPlugin/HorizonTweenDemo/Build/UGSBuild` — `Intermediate/BuildUGS/NuGet/*.nupkg`.
